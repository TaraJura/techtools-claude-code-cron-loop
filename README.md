...
Compress PDFs · PDF/A archival conversion · Print preparation (bleed, marks) · Repair corrupted PDFs · Font inspector · Image inspector (read-only) · Links inspector · JavaScript & actions inspector (read-only) · Document statistics · Metadata editor
