...
Merge · Interleave pages from two PDFs · Split by ranges, bookmarks, or file size · Reorder / rotate / delete / duplicate pages · N-up (2/4 pages per sheet) · Add margins (whitespace / binding gutter) · Resize pages to standard formats · Insert blank or existing pages · Manual & auto crop · Deskew scanned pages · Brightness / contrast / grayscale adjust
